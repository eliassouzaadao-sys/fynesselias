...
interface CentroCusto {
  ...
  level?: number;
  isParent?: boolean;
  hasSubcentros?: boolean;
  bloqueadoParaLancamento?: boolean;
  isSocio?: boolean;
}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="min-w-0 md:col-span-2">
                      ...
                      {centros.some((c: any) => c.bloqueadoParaLancamento) && (
                        <p className="text-[10px] text-muted-foreground mt-1">
                          Centros com subcentros estao bloqueados - selecione um subcentro especifico
                        </p>
                      )}
                    </div>
                  </div>
